...
opi_pcb_w       = 90;       // mm - board width (X in enclosure)
opi_pcb_d       = 64;       // mm - board depth (Y in enclosure)
opi_mount_w     = 82;       // mm - mounting hole spacing X
opi_mount_d     = 56;       // mm - mounting hole spacing Y
opi_mount_hole  = 2.7;      // M2.5 clearance
opi_standoff_d  = 6;        // mm - standoff outer diameter
opi_standoff_h  = 8;        // mm - standoff height (clearance under board)
// Position: right half, between display and pots, near back panel
opi_x           = length/2 + 50;   // X position (center of board)
opi_y           = 205;             // Y position (behind display, near back wall)
