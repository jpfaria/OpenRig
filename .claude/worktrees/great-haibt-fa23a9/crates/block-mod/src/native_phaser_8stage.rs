...
pub const MODEL_ID: &str = "phaser_8stage";
pub const DISPLAY_NAME: &str = "8-Stage Phaser";

const TUNING: PhaserTuning = PhaserTuning {
    stages: 8,
    min_freq_hz: 100.0,
    max_freq_hz: 3_000.0,
    skew_strength: 0.85,
...
fn parse(params: &ParameterSet) -> Result<P8Params> {
    Ok(P8Params {
    ...
    Ok(ModelParameterSchema {
        ...
        parameters: vec![
            ...
            float_parameter(
                ...
                "Feedback",
                None,
                Some(P8Params::default().feedback),
                -95.0,
                95.0,
                1.0,
                ParameterUnit::Percent,
