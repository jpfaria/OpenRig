...
use stage_amp_head::native::{
    build_native_head_mono_processor, NativeAmpHeadSettings, NativeAmpHeadVoice,
};
use stage_cab::native::{build_native_cab_mono_processor, NativeCabSettings, NativeCabVoice};
...
pub fn build_processor_for_model(
    ...
    match layout {
        AudioChannelLayout::Mono => Ok(StageProcessor::Mono(build_native_combo_mono_processor(
            voice,
            settings,
            sample_rate,
        ))),
