...
const PLUGIN_DIR: &str = "GxValveCaster";

#[cfg(target_os = "macos")]
const PLUGIN_BINARY: &str = "GxValveCaster.dylib";
#[cfg(target_os = "linux")]
const PLUGIN_BINARY: &str = "GxValveCaster.so";
#[cfg(target_os = "windows")]
const PLUGIN_BINARY: &str = "GxValveCaster.dll";
