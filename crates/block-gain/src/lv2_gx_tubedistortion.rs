...
const PLUGIN_DIR: &str = "GxTubeDistortion";

#[cfg(target_os = "macos")]
const PLUGIN_BINARY: &str = "GxTubeDistortion.dylib";
#[cfg(target_os = "linux")]
const PLUGIN_BINARY: &str = "GxTubeDistortion.so";
#[cfg(target_os = "windows")]
const PLUGIN_BINARY: &str = "GxTubeDistortion.dll";
