...
pub const MODEL_ID: &str = "flanger_jet";
pub const DISPLAY_NAME: &str = "Jet Flanger";
...
fn parse(params: &ParameterSet) -> Result<JetParams> {
    Ok(JetParams {
    ...
    Ok(ModelParameterSchema {
        ...
        parameters: vec![
            float_parameter(
                ...
                "Rate",
                None,
                Some(JetParams::default().rate_hz),
                0.05,
                5.0,
                0.05,
                ParameterUnit::Hertz,
            ...
            float_parameter(
                ...
                "Feedback",
                None,
                Some(JetParams::default().feedback),
                -99.0,
                99.0,
                1.0,
                ParameterUnit::Percent,
