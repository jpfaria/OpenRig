//! Funk auto-wah variant — tighter range, faster envelope, narrow
//! peak. The "Bootsy / disco quack" voice. Same engine as
...
pub const MODEL_ID: &str = "auto_wah_funk";
pub const DISPLAY_NAME: &str = "Auto-Wah (Funk)";

const TUNING: AutoWahTuning = AutoWahTuning {
    min_cutoff_hz: 350.0,
    max_cutoff_hz: 2_500.0,
    q: 9.0,
    attack_ms: 2.0,
    release_ms: 40.0,
    sensitivity: 1.5,
...
fn schema() -> Result<ModelParameterSchema> {
    Ok(ModelParameterSchema {
        ...
        parameters: vec![
            float_parameter("sensitivity", "Sensitivity", Some("Wah"), Some(70.0), 0.0, 100.0, 1.0, ParameterUnit::Percent),
            float_parameter("range", "Range", Some("Wah"), Some(80.0), 0.0, 100.0, 1.0, ParameterUnit::Percent),
            float_parameter("q", "Q", Some("Wah"), Some(60.0), 0.0, 100.0, 1.0, ParameterUnit::Percent),
