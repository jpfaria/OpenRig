...
pub const CAPTURES: &[Capture] = &[
    capture!("ir_hd28_m80_allstr_44100", "body.martin_hd_28_pre2018_baggs_m80.ir_hd28_m80_allstr_44100", "captures/ir/body/martin_hd_28_pre2018_baggs_m80/ir_hd28_m80_allstr_44100.wav"),
    capture!("ir_hd28_m80_allstr_44100_match1", "body.martin_hd_28_pre2018_baggs_m80.ir_hd28_m80_allstr_44100_match1", "captures/ir/body/martin_hd_28_pre2018_baggs_m80/ir_hd28_m80_allstr_44100_match1.wav"),
    capture!("ir_hd28_m80_allstr_44100_match2", "body.martin_hd_28_pre2018_baggs_m80.ir_hd28_m80_allstr_44100_match2", "captures/ir/body/martin_hd_28_pre2018_baggs_m80/ir_hd28_m80_allstr_44100_match2.wav"),
    capture!("ir_hd28_m80_estr_44100", "body.martin_hd_28_pre2018_baggs_m80.ir_hd28_m80_estr_44100", "captures/ir/body/martin_hd_28_pre2018_baggs_m80/ir_hd28_m80_estr_44100.wav"),
    capture!("ir_hd28_m80_estr_44100_match1", "body.martin_hd_28_pre2018_baggs_m80.ir_hd28_m80_estr_44100_match1", "captures/ir/body/martin_hd_28_pre2018_baggs_m80/ir_hd28_m80_estr_44100_match1.wav"),
    capture!("ir_hd28_m80_estr_44100_match2", "body.martin_hd_28_pre2018_baggs_m80.ir_hd28_m80_estr_44100_match2", "captures/ir/body/martin_hd_28_pre2018_baggs_m80/ir_hd28_m80_estr_44100_match2.wav"),
];
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("ir_hd28_m80_allstr_44100".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
