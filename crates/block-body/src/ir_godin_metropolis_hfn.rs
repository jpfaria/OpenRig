...
pub struct GodinMetropolisHfnCapture { pub voicing: &'static str, pub asset: EmbeddedAsset }

pub const CAPTURES: &[GodinMetropolisHfnCapture] = &[
    capture!("jf45ir1024godin_metropolis", "body.godin_metropolis_hfn.jf45ir1024godin_metropolis", "captures/ir/body/godin_metropolis_hfn/jf45ir1024godin_metropolis.wav"),
    capture!("jf45ir5050godin_metropolis", "body.godin_metropolis_hfn.jf45ir5050godin_metropolis", "captures/ir/body/godin_metropolis_hfn/jf45ir5050godin_metropolis.wav"),
    capture!("jf45irgodin_metropolis", "body.godin_metropolis_hfn.jf45irgodin_metropolis", "captures/ir/body/godin_metropolis_hfn/jf45irgodin_metropolis.wav"),
];
