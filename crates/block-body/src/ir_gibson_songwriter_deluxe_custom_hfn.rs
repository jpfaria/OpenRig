...
pub struct GibsonSongwriterDeluxeCustomHfnCapture { pub voicing: &'static str, pub asset: EmbeddedAsset }

pub const CAPTURES: &[GibsonSongwriterDeluxeCustomHfnCapture] = &[
    capture!("jf45ir1024gibson", "body.gibson_songwriter_deluxe_custom_hfn.jf45ir1024gibson", "captures/ir/body/gibson_songwriter_deluxe_custom_hfn/jf45ir1024gibson.wav"),
    capture!("jf45ir5050gibson", "body.gibson_songwriter_deluxe_custom_hfn.jf45ir5050gibson", "captures/ir/body/gibson_songwriter_deluxe_custom_hfn/jf45ir5050gibson.wav"),
    capture!("jf45irgibson", "body.gibson_songwriter_deluxe_custom_hfn.jf45irgibson", "captures/ir/body/gibson_songwriter_deluxe_custom_hfn/jf45irgibson.wav"),
];
