...
pub const CAPTURES: &[MartinOm28Capture] = &[
    capture!("standard", "body.martin_om_28.standard", "captures/ir/body/martin_om_28/standard.wav"),
    capture!("blend", "body.martin_om_28.blend", "captures/ir/body/martin_om_28/blend.wav"),
    capture!("match", "body.martin_om_28.match", "captures/ir/body/martin_om_28/match.wav"),
    capture!("jf", "body.martin_om_28.jf", "captures/ir/body/martin_om_28/jf_flavor.wav"),
];
