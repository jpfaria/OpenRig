...
pub const CAPTURES: &[Capture] = &[
    capture!("lescotton_westfield", "body.les_cotton_westfield.lescotton_westfield", "captures/ir/body/les_cotton_westfield/lescotton_westfield.wav"),
    capture!("cukiirlescottonwest2048_48", "body.les_cotton_westfield.cukiirlescottonwest2048_48", "captures/ir/body/les_cotton_westfield/cukiirlescottonwest2048_48.wav"),
    capture!("cukijfirlescottonwest2048at48", "body.les_cotton_westfield.cukijfirlescottonwest2048at48", "captures/ir/body/les_cotton_westfield/cukijfirlescottonwest2048at48.wav"),
    capture!("jf45irlescotton_westfield", "body.les_cotton_westfield.jf45irlescotton_westfield", "captures/ir/body/les_cotton_westfield/jf45irlescotton_westfield.wav"),
    capture!("jf45ir1024lescotton_westfield", "body.les_cotton_westfield.jf45ir1024lescotton_westfield", "captures/ir/body/les_cotton_westfield/jf45ir1024lescotton_westfield.wav"),
    capture!("jf45ir5050lescotton_westfield", "body.les_cotton_westfield.jf45ir5050lescotton_westfield", "captures/ir/body/les_cotton_westfield/jf45ir5050lescotton_westfield.wav"),
];
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("lescotton_westfield".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
