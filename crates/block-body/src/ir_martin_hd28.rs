...
pub const CAPTURES: &[Capture] = &[
    capture!("hd28_neumann_u87", "body.martin_hd28.hd28_neumann_u87", "captures/ir/body/martin_hd28/hd28_neumann_u87.wav"),
    capture!("hd28_neumann_u47", "body.martin_hd28.hd28_neumann_u47", "captures/ir/body/martin_hd28/hd28_neumann_u47.wav"),
    capture!("hd28_soundelux_e47", "body.martin_hd28.hd28_soundelux_e47", "captures/ir/body/martin_hd28/hd28_soundelux_e47.wav"),
    capture!("hd28_akg_c414b_xls", "body.martin_hd28.hd28_akg_c414b_xls", "captures/ir/body/martin_hd28/hd28_akg_c414b_xls.wav"),
    capture!("hd28_schoeps_cmc64g", "body.martin_hd28.hd28_schoeps_cmc64g", "captures/ir/body/martin_hd28/hd28_schoeps_cmc64g.wav"),
];
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("hd28_neumann_u87".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
