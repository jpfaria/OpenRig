...
pub const CAPTURES: &[MartinD35Capture] = &[
    capture!("exp", "body.martin_d_35.exp", "captures/ir/body/martin_d_35/exp.wav"),
    capture!("piezo_1", "body.martin_d_35.piezo_1", "captures/ir/body/martin_d_35/piezo_1.wav"),
    capture!("piezo_2", "body.martin_d_35.piezo_2", "captures/ir/body/martin_d_35/piezo_2.wav"),
    capture!("piezo_3", "body.martin_d_35.piezo_3", "captures/ir/body/martin_d_35/piezo_3.wav"),
    capture!("soundboard_1", "body.martin_d_35.soundboard_1", "captures/ir/body/martin_d_35/soundboard_1.wav"),
    capture!("soundboard_2", "body.martin_d_35.soundboard_2", "captures/ir/body/martin_d_35/soundboard_2.wav"),
    capture!("blend", "body.martin_d_35.blend", "captures/ir/body/martin_d_35/blend.wav"),
];
