...
pub const CAPTURES: &[Capture] = &[
    capture!("yamaha_ll16_48000", "body.yamaha_ll16.yamaha_ll16_48000", "captures/ir/body/yamaha_ll16/yamaha_ll16_48000.wav"),
    capture!("yamaha_ll16_48000_bld", "body.yamaha_ll16.yamaha_ll16_48000_bld", "captures/ir/body/yamaha_ll16/yamaha_ll16_48000_bld.wav"),
    capture!("yamaha_ll16_48000_match", "body.yamaha_ll16.yamaha_ll16_48000_match", "captures/ir/body/yamaha_ll16/yamaha_ll16_48000_match.wav"),
    capture!("yamaha_ll16_48000_jf_flavor", "body.yamaha_ll16.yamaha_ll16_48000_jf_flavor", "captures/ir/body/yamaha_ll16/yamaha_ll16_48000_jf_flavor.wav"),
];
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("yamaha_ll16_48000".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
