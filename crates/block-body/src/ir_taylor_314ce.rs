...
pub const CAPTURES: &[Capture] = &[
    capture!("taylor_314ce_dpa_4011", "body.taylor_314ce.taylor_314ce_dpa_4011", "captures/ir/body/taylor_314ce/taylor_314ce_dpa_4011.wav"),
    capture!("taylor_314ce_earthworks_qtc30", "body.taylor_314ce.taylor_314ce_earthworks_qtc30", "captures/ir/body/taylor_314ce/taylor_314ce_earthworks_qtc30.wav"),
    capture!("taylor_314ce_neumann_m147", "body.taylor_314ce.taylor_314ce_neumann_m147", "captures/ir/body/taylor_314ce/taylor_314ce_neumann_m147.wav"),
    capture!("taylor_314ce_neumann_u87", "body.taylor_314ce.taylor_314ce_neumann_u87", "captures/ir/body/taylor_314ce/taylor_314ce_neumann_u87.wav"),
    capture!("taylor_314ce_scheops_cmc64g", "body.taylor_314ce.taylor_314ce_scheops_cmc64g", "captures/ir/body/taylor_314ce/taylor_314ce_scheops_cmc64g.wav"),
    capture!("taylor_314ce_shure_sm57", "body.taylor_314ce.taylor_314ce_shure_sm57", "captures/ir/body/taylor_314ce/taylor_314ce_shure_sm57.wav"),
    capture!("taylor_314ce_soundelux_e47", "body.taylor_314ce.taylor_314ce_soundelux_e47", "captures/ir/body/taylor_314ce/taylor_314ce_soundelux_e47.wav"),
];
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("taylor_314ce_dpa_4011".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
