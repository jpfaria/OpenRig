...
pub const CAPTURES: &[RainsongChPa1100nsgCapture] = &[
    capture!("standard", "body.rainsong_ch_pa1100nsg.standard", "captures/ir/body/rainsong_ch_pa1100nsg/jf_rainsong_ch_pa1100nsg_hfn_44100.wav"),
    capture!("blend", "body.rainsong_ch_pa1100nsg.blend", "captures/ir/body/rainsong_ch_pa1100nsg/jf_rainsong_ch_pa1100nsg_hfn_44100_bld.wav"),
    capture!("match", "body.rainsong_ch_pa1100nsg.match", "captures/ir/body/rainsong_ch_pa1100nsg/rainsong_parlor_44100_matcheq.wav"),
    capture!("jf", "body.rainsong_ch_pa1100nsg.jf", "captures/ir/body/rainsong_ch_pa1100nsg/jf_rainsong_ch_pa1100nsg_hfn_44100_jf_flavor.wav"),
];
