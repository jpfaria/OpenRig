...
pub const CAPTURES: &[MartinLx1eCapture] = &[
    capture!("standard", "body.martin_lx1e.standard", "captures/ir/body/martin_lx1e/martin_lx1e_sonitone_48000.wav"),
    capture!("blend", "body.martin_lx1e.blend", "captures/ir/body/martin_lx1e/martin_lx1e_sonitone_48000_bld.wav"),
    capture!("match", "body.martin_lx1e.match", "captures/ir/body/martin_lx1e/martin_lx1e_sonitone_48000_match.wav"),
    capture!("jf", "body.martin_lx1e.jf", "captures/ir/body/martin_lx1e/martin_lx1e_sonitone_48000_jf_flavor.wav"),
];
