...
pub const CAPTURES: &[Capture] = &[
    capture!("holy_grail_c800_exp", "body.mcpherson_camrielle.holy_grail_c800_exp", "captures/ir/body/mcpherson_camrielle/holy_grail_c800_exp.wav"),
    capture!("holy_grail_c800_pz1", "body.mcpherson_camrielle.holy_grail_c800_pz1", "captures/ir/body/mcpherson_camrielle/holy_grail_c800_pz1.wav"),
    capture!("holy_grail_c800_pz2", "body.mcpherson_camrielle.holy_grail_c800_pz2", "captures/ir/body/mcpherson_camrielle/holy_grail_c800_pz2.wav"),
    capture!("holy_grail_c800_pz3", "body.mcpherson_camrielle.holy_grail_c800_pz3", "captures/ir/body/mcpherson_camrielle/holy_grail_c800_pz3.wav"),
    capture!("holy_grail_c800_sb1", "body.mcpherson_camrielle.holy_grail_c800_sb1", "captures/ir/body/mcpherson_camrielle/holy_grail_c800_sb1.wav"),
    capture!("holy_grail_c800_sb2", "body.mcpherson_camrielle.holy_grail_c800_sb2", "captures/ir/body/mcpherson_camrielle/holy_grail_c800_sb2.wav"),
    capture!("holy_grail_c800_sb3_blend", "body.mcpherson_camrielle.holy_grail_c800_sb3_blend", "captures/ir/body/mcpherson_camrielle/holy_grail_c800_sb3_blend.wav"),
];
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("holy_grail_c800_exp".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
