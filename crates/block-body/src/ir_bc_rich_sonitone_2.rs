...
pub const CAPTURES: &[Capture] = &[
    capture!("bc_rich_plywood_sonitone_44100", "body.bc_rich_sonitone_2.bc_rich_plywood_sonitone_44100", "captures/ir/body/bc_rich_sonitone_2/bc_rich_plywood_sonitone_44100.wav"),
    capture!("bc_rich_plywood_sonitone_44100_match1", "body.bc_rich_sonitone_2.bc_rich_plywood_sonitone_44100_match1", "captures/ir/body/bc_rich_sonitone_2/bc_rich_plywood_sonitone_44100_match1.wav"),
    capture!("bc_rich_plywood_sonitone_44100_match2", "body.bc_rich_sonitone_2.bc_rich_plywood_sonitone_44100_match2", "captures/ir/body/bc_rich_sonitone_2/bc_rich_plywood_sonitone_44100_match2.wav"),
    capture!("cukiirpwfs2048at48", "body.bc_rich_sonitone_2.cukiirpwfs2048at48", "captures/ir/body/bc_rich_sonitone_2/cukiirpwfs2048at48.wav"),
    capture!("cukijfirpwfs2048at48", "body.bc_rich_sonitone_2.cukijfirpwfs2048at48", "captures/ir/body/bc_rich_sonitone_2/cukijfirpwfs2048at48.wav"),
    capture!("jf45irpwfs", "body.bc_rich_sonitone_2.jf45irpwfs", "captures/ir/body/bc_rich_sonitone_2/jf45irpwfs.wav"),
    capture!("jf45ir1024pwfs", "body.bc_rich_sonitone_2.jf45ir1024pwfs", "captures/ir/body/bc_rich_sonitone_2/jf45ir1024pwfs.wav"),
    capture!("jf45ir5050pwfs", "body.bc_rich_sonitone_2.jf45ir5050pwfs", "captures/ir/body/bc_rich_sonitone_2/jf45ir5050pwfs.wav"),
];
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("bc_rich_plywood_sonitone_44100".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
