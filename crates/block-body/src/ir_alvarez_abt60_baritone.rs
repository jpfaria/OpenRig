...
pub const CAPTURES: &[Capture] = &[
    capture!("ir_alvarez_abt_60_baritone_sm44100", "body.alvarez_abt60_baritone.ir_alvarez_abt_60_baritone_sm44100", "captures/ir/body/alvarez_abt60_baritone/ir_alvarez_abt_60_baritone_sm44100.wav"),
    capture!("ir_alvarez_abt_60_baritone_sm44100_match1", "body.alvarez_abt60_baritone.ir_alvarez_abt_60_baritone_sm44100_match1", "captures/ir/body/alvarez_abt60_baritone/ir_alvarez_abt_60_baritone_sm44100_match1.wav"),
    capture!("ir_alvarez_abt_60_baritone_sm44100_match2", "body.alvarez_abt60_baritone.ir_alvarez_abt_60_baritone_sm44100_match2", "captures/ir/body/alvarez_abt60_baritone/ir_alvarez_abt_60_baritone_sm44100_match2.wav"),
    capture!("ir_alvarez_abt_60_baritone_bb44100", "body.alvarez_abt60_baritone.ir_alvarez_abt_60_baritone_bb44100", "captures/ir/body/alvarez_abt60_baritone/ir_alvarez_abt_60_baritone_bb44100.wav"),
    capture!("ir_alvarez_abt_60_baritone_bb44100_match1", "body.alvarez_abt60_baritone.ir_alvarez_abt_60_baritone_bb44100_match1", "captures/ir/body/alvarez_abt60_baritone/ir_alvarez_abt_60_baritone_bb44100_match1.wav"),
    capture!("ir_alvarez_abt_60_baritone_bb44100_match2", "body.alvarez_abt60_baritone.ir_alvarez_abt_60_baritone_bb44100_match2", "captures/ir/body/alvarez_abt60_baritone/ir_alvarez_abt_60_baritone_bb44100_match2.wav"),
];
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("ir_alvarez_abt_60_baritone_sm44100".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
