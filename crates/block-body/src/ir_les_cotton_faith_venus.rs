...
pub const CAPTURES: &[Capture] = &[
    capture!("lescotton_faith_venus", "body.les_cotton_faith_venus.lescotton_faith_venus", "captures/ir/body/les_cotton_faith_venus/lescotton_faith_venus.wav"),
    capture!("cukiirlescottonfaith2048at48", "body.les_cotton_faith_venus.cukiirlescottonfaith2048at48", "captures/ir/body/les_cotton_faith_venus/cukiirlescottonfaith2048at48.wav"),
    capture!("cukijfirlescottonfaith2048at48", "body.les_cotton_faith_venus.cukijfirlescottonfaith2048at48", "captures/ir/body/les_cotton_faith_venus/cukijfirlescottonfaith2048at48.wav"),
    capture!("jf45irlescotton_faith_venus", "body.les_cotton_faith_venus.jf45irlescotton_faith_venus", "captures/ir/body/les_cotton_faith_venus/jf45irlescotton_faith_venus.wav"),
    capture!("jf45ir1024lescotton_faith_venus", "body.les_cotton_faith_venus.jf45ir1024lescotton_faith_venus", "captures/ir/body/les_cotton_faith_venus/jf45ir1024lescotton_faith_venus.wav"),
    capture!("jf45ir5050lescotton_faith_venus", "body.les_cotton_faith_venus.jf45ir5050lescotton_faith_venus", "captures/ir/body/les_cotton_faith_venus/jf45ir5050lescotton_faith_venus.wav"),
];
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("lescotton_faith_venus".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
