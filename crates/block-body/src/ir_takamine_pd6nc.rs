...
pub const CAPTURES: &[Capture] = &[
    capture!("takamine_pd6nc_1_44100", "body.takamine_pd6nc.takamine_pd6nc_1_44100", "captures/ir/body/takamine_pd6nc/takamine_pd6nc_1_44100.wav"),
    capture!("takamine_pd6nc_1_44100_bld", "body.takamine_pd6nc.takamine_pd6nc_1_44100_bld", "captures/ir/body/takamine_pd6nc/takamine_pd6nc_1_44100_bld.wav"),
    capture!("takamine_pd6nc_1_44100_match", "body.takamine_pd6nc.takamine_pd6nc_1_44100_match", "captures/ir/body/takamine_pd6nc/takamine_pd6nc_1_44100_match.wav"),
    capture!("takamine_pd6nc_1_44100_jf_flavor", "body.takamine_pd6nc.takamine_pd6nc_1_44100_jf_flavor", "captures/ir/body/takamine_pd6nc/takamine_pd6nc_1_44100_jf_flavor.wav"),
    capture!("takamine_pd6nc_2_44100", "body.takamine_pd6nc.takamine_pd6nc_2_44100", "captures/ir/body/takamine_pd6nc/takamine_pd6nc_2_44100.wav"),
    capture!("takamine_pd6nc_2_44100_bld", "body.takamine_pd6nc.takamine_pd6nc_2_44100_bld", "captures/ir/body/takamine_pd6nc/takamine_pd6nc_2_44100_bld.wav"),
    capture!("takamine_pd6nc_2_44100_match", "body.takamine_pd6nc.takamine_pd6nc_2_44100_match", "captures/ir/body/takamine_pd6nc/takamine_pd6nc_2_44100_match.wav"),
    capture!("takamine_pd6nc_2_44100_jf_flavor", "body.takamine_pd6nc.takamine_pd6nc_2_44100_jf_flavor", "captures/ir/body/takamine_pd6nc/takamine_pd6nc_2_44100_jf_flavor.wav"),
];
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("takamine_pd6nc_1_44100".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
