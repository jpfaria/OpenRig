...
pub const CAPTURES: &[Capture] = &[
    capture!("cs_0015_knk_44100", "body.martin_custom_shop_00_15_k_k.cs_0015_knk_44100", "captures/ir/body/martin_custom_shop_00_15_k_k/cs_0015_knk_44100.wav"),
    capture!("cs_0015_knk_44100_match2", "body.martin_custom_shop_00_15_k_k.cs_0015_knk_44100_match2", "captures/ir/body/martin_custom_shop_00_15_k_k/cs_0015_knk_44100_match2.wav"),
    capture!("jf45ircs0015jf", "body.martin_custom_shop_00_15_k_k.jf45ircs0015jf", "captures/ir/body/martin_custom_shop_00_15_k_k/jf45ircs0015jf.wav"),
    capture!("jf45ir1024cs0015jf", "body.martin_custom_shop_00_15_k_k.jf45ir1024cs0015jf", "captures/ir/body/martin_custom_shop_00_15_k_k/jf45ir1024cs0015jf.wav"),
    capture!("jf45ir5050cs0015jf", "body.martin_custom_shop_00_15_k_k.jf45ir5050cs0015jf", "captures/ir/body/martin_custom_shop_00_15_k_k/jf45ir5050cs0015jf.wav"),
];
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("cs_0015_knk_44100".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
