...
pub const CAPTURES: &[Capture] = &[
    capture!("dy", "body.hamblin_gc_barbera.dy", "captures/ir/body/hamblin_gc_barbera/dy.wav"),
    capture!("cukiir2048at48", "body.hamblin_gc_barbera.cukiir2048at48", "captures/ir/body/hamblin_gc_barbera/cukiir2048at48.wav"),
    capture!("cukijfir2048at48", "body.hamblin_gc_barbera.cukijfir2048at48", "captures/ir/body/hamblin_gc_barbera/cukijfir2048at48.wav"),
    capture!("jf45irdy", "body.hamblin_gc_barbera.jf45irdy", "captures/ir/body/hamblin_gc_barbera/jf45irdy.wav"),
    capture!("jf45ir1024dy", "body.hamblin_gc_barbera.jf45ir1024dy", "captures/ir/body/hamblin_gc_barbera/jf45ir1024dy.wav"),
    capture!("jf45ir5050dy", "body.hamblin_gc_barbera.jf45ir5050dy", "captures/ir/body/hamblin_gc_barbera/jf45ir5050dy.wav"),
];
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("dy".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
