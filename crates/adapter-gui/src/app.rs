...
use crate::{
    AppWindow, BlockEditorWindow, CompactChainViewWindow, ChainInsertWindow,
    ChainInputWindow, ChainOutputWindow, ChainInputGroupsWindow, ChainOutputGroupsWindow,
    ProjectSettingsWindow, ChainEditorWindow, PluginInfoWindow,
    ProjectChainItem, BlockParameterItem, BlockTypePickerItem, BlockModelPickerItem,
    RecentProjectItem, DeviceSelectionItem, ChannelOptionItem, MultiSliderPoint,
    CurveEditorPoint, BlockKnobOverlay,
...
use crate::eq::{compute_eq_curves, build_multi_slider_points, build_curve_editor_points};
use crate::helpers::{
...
pub fn run_desktop_app(
    ...
    }
    {
        ...
        window.on_add_chain(move || {
            ...
            callbacks::chain_editor_win::setup_chain_editor_callbacks(
                &editor_window,
                window.as_weak(),
                chain_draft.clone(),
...
pub(crate) fn assign_new_block_ids_recursive(block: &mut AudioBlock, chain_id: &ChainId) {
