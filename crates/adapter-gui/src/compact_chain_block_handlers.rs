...
pub(crate) fn wire(
    ...
    wire_block_toggle_and_model(main_window, compact_win, &ctx);
    wire_chain_toggle(main_window, compact_win, &ctx);
    crate::compact_chain_block_delete::wire_block_delete(main_window, compact_win, &ctx);
    crate::compact_chain_block_delete::wire_block_reorder(main_window, compact_win, &ctx);
}

fn wire_block_toggle_and_model(
    main_window: &AppWindow,
    compact_win: &CompactChainViewWindow,
    ctx: &CompactChainBlockHandlersCtx,
) {
