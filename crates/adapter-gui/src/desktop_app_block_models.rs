...
pub(crate) fn init(window: &AppWindow) -> BlockEditorModels {
    ...
    crate::BlockEditorBridge::get(window)
        .set_block_type_options(ModelRc::from(block_type_options.clone()));
    crate::BlockEditorBridge::get(window)
        .set_block_model_options(ModelRc::from(block_model_options.clone()));
    crate::BlockEditorBridge::get(window)
    ...
    crate::BlockEditorBridge::get(window)
        .set_block_parameter_items(ModelRc::from(block_parameter_items.clone()));
    crate::BlockEditorBridge::get(window)
        .set_multi_slider_points(ModelRc::from(multi_slider_points.clone()));
    crate::BlockEditorBridge::get(window)
        .set_curve_editor_points(ModelRc::from(curve_editor_points.clone()));
