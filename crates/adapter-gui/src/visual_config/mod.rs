...
mod tests {
    ...
    fn all_entries_covers_all_30_brands() {
        ...
        let brands: std::collections::HashSet<&str> = entries
            ...
            .collect();
        let expected_brands = [
            "bogner", "boss", "collings", "cort", "diezel", "dumble",
            "emerald", "evh", "fender", "gibson", "godin", "guild",
            "ibanez", "jhs", "lakewood", "lowden", "marshall", "martin",
            "mesa", "morris", "ovation", "peavey", "rainsong", "roland",
            "santa_cruz", "suhr", "takamine", "taylor", "vox", "yamaha",
        ];
    ...
    fn all_entries_covers_all_native_models() {
        ...
        let expected_native = [
            ...
            "american_2x12", "brit_4x12", "vintage_1x12",
            "analog_warm", "digital_clean", "modulated_delay",
            "reverse", "slapback", "tape_vintage",
            "plate_foundation",
            "compressor_studio_clean", "gate_basic",
            "eq_three_band_basic",
            "cry_classic",
            "tremolo_sine",
            "octave_simple",
