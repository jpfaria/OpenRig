...
pub fn model_schema() -> ModelParameterSchema {
    ...
    schema.parameters = vec![enum_parameter(
        ...
        Some("cathedral_stmn"),
        &[
            ("cathedral_stmn", "Cathedral STMN"),
            ("dde_thronolith_only_pedal", "DDE - Thronolith (Only Pedal)"),
            ("dde_life_droner_nocab", "DDE - Life Droner (NoCab)"),
            ("dde_hyper_droner_nocab", "DDE - Hyper Droner (NoCab)"),
        ],
    )];
    schema
}
