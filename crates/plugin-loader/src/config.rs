//! Resolves where the plugin bundle directory lives at runtime.
//!
//! Order of precedence:
//!   1. `OPENRIG_PLUGINS_ROOT` environment variable.
//!   2. `plugins_root:` field in the project-root `config.yaml`.
//!   3. Sibling-cloned default `../OpenRig-plugins/plugins/bundle` (the
...
/// Resolve the plugin bundle directory to use at runtime.
///
...
/// development: `<config dir>/../OpenRig-plugins/plugins/bundle`.
pub fn plugins_root_from_config(config_path: &Path) -> PathBuf {
    ...
    config_dir.join("../OpenRig-plugins/plugins/bundle")
}
