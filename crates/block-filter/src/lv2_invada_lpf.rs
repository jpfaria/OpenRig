...
pub const MODEL_ID: &str = "lv2_invada_lpf";
pub const DISPLAY_NAME: &str = "Invada Low Pass";
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![
            float_parameter("frequency", "Frequency", None, Some(1000.0), 20.0, 20000.0, 10.0, ParameterUnit::Hertz),
...
fn build_mono(sample_rate: f32, frequency: f32, gain: f32, drive: f32) -> Result<lv2::Lv2Processor> {
    ...
    lv2::build_lv2_processor_with_extras(
        ...
        &[], // meter outputs don't need connection
    )
}
