...
fn build_mono_processor(
    sample_rate: f32,
    band1_gain: f32, band1_freq: f32,
    band2_gain: f32, band2_freq: f32,
    band3_gain: f32, band3_freq: f32,
    band4_gain: f32, band4_freq: f32,
    band5_gain: f32, band5_freq: f32,
    band6_gain: f32, band6_freq: f32,
    band7_gain: f32, band7_freq: f32,
    band8_gain: f32, band8_freq: f32,
    ...
    match layout {
        AudioChannelLayout::Mono => {
            let processor = build_mono_processor(
                ...
                band2_gain, band2_freq,
                band3_gain, band3_freq,
                band4_gain, band4_freq,
                band5_gain, band5_freq,
                band6_gain, band6_freq,
                band7_gain, band7_freq,
                band8_gain, band8_freq,
            )?;
