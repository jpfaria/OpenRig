...
pub(crate) fn enumerate_input_devices_uncached() -> Result<Vec<AudioDeviceDescriptor>> {
    #[cfg(all(target_os = "linux", feature = "jack"))]
    {
        if jack_server_is_running() {
...
pub(crate) fn enumerate_output_devices_uncached() -> Result<Vec<AudioDeviceDescriptor>> {
    #[cfg(all(target_os = "linux", feature = "jack"))]
    {
        if jack_server_is_running() {
