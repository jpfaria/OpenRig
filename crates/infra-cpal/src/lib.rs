...
mod cpu_affinity;
#[cfg(all(target_os = "linux", feature = "jack"))]
use cpu_affinity::{detect_big_cores, pin_thread_to_cpus};

#[cfg(all(target_os = "linux", feature = "jack"))]
mod jack_handlers;
#[cfg(all(target_os = "linux", feature = "jack"))]
use jack_handlers::{JackProcessHandler, JackShutdownHandler, SpscRingBuffer};

mod active_runtime;
use active_runtime::ActiveChainRuntime;
#[cfg(all(target_os = "linux", feature = "jack"))]
use active_runtime::DspWorkerHandle;
