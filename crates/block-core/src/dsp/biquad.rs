//! Responsibility: filters a signal with a biquad section.
//!
//! Coefficients are ramped over `BIQUAD_COEFF_RAMP_FRAMES` so a parameter
//! move does not step the filter and click.
